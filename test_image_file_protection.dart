...
Future<void> testImageOrderSaveProtection() async {
  ...
  final beforeOrder = [
    {
      'id': 'img1',
      'index': 0,
      'path': 'C:\\work\\$workId\\images\\img1_imported.png'
    },
    {
      'id': 'img2',
      'index': 1,
      'path': 'C:\\work\\$workId\\images\\img2_imported.png'
    },
    {
      'id': 'img3',
      'index': 2,
      'path': 'C:\\work\\$workId\\images\\img3_imported.png'
    },
  ];
  ...
  for (final img in afterOrder) {
    ...
    const basePath = 'C:\\work\\$workId\\images\\';
  ...
  for (final importantFile in importantFiles) {
    final isProtected =
        normalizedUsedPaths.any((path) => path.contains(importantFile));
  ...
  for (final file in unusedFiles) {
    if (file.contains('imported.png') ||
        file.contains('original.jpg') ||
        file.contains('thumbnail.jpg')) {
