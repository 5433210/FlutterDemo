...
class BatchLogger {
  ...
  static void addToBatch(String batchKey, LogLevel level, String message,
    ...
    _timers[batchKey] = Timer(
        const Duration(milliseconds: _batchDelay), () => _flushBatch(batchKey));
  }
...
extension EditPageLogger on AppLogger {
  ...
  static void canvasDebug(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableCanvasLogging &&
        _shouldLog(LogLevel.debug, EditPageLoggingConfig.canvasMinLevel)) {
      AppLogger.debug(message,
          tag: tag ?? EditPageLoggingConfig.TAG_CANVAS, data: data);
    }
  }

  static void canvasError(String message,
      {String? tag,
      Object? error,
    ...
    if (EditPageLoggingConfig.enableCanvasLogging &&
      ...
      AppLogger.error(message,
          tag: tag ?? EditPageLoggingConfig.TAG_CANVAS,
          error: error,
          stackTrace: stackTrace,
          data: data);
    }
  ...
  static void controllerDebug(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableControllerLogging &&
        _shouldLog(LogLevel.debug, EditPageLoggingConfig.controllerMinLevel)) {
      AppLogger.debug(message,
          tag: tag ?? EditPageLoggingConfig.TAG_CONTROLLER, data: data);
    }
  }

  static void controllerError(String message,
      {String? tag,
      Object? error,
      StackTrace? stackTrace,
      Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableControllerLogging &&
      ...
      AppLogger.error(message,
          tag: tag ?? EditPageLoggingConfig.TAG_CONTROLLER,
          error: error,
          stackTrace: stackTrace,
          data: data);
    }
  ...
  static void controllerInfo(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableControllerLogging &&
  ...
  static void controllerWarning(String message,
      {String? tag, Map<String, dynamic>? data, Object? error}) {
    if (EditPageLoggingConfig.enableControllerLogging &&
        _shouldLog(
            LogLevel.warning, EditPageLoggingConfig.controllerMinLevel)) {
  ...
  static void editPageDebug(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableEditPageLogging &&
        _shouldLog(LogLevel.debug, EditPageLoggingConfig.editPageMinLevel)) {
      AppLogger.debug(message,
          tag: tag ?? EditPageLoggingConfig.TAG_EDIT_PAGE, data: data);
    }
  }

  static void editPageError(String message,
      {String? tag,
      Object? error,
      StackTrace? stackTrace,
      Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableEditPageLogging &&
      ...
      AppLogger.error(message,
          tag: tag ?? EditPageLoggingConfig.TAG_EDIT_PAGE,
          error: error,
          stackTrace: stackTrace,
          data: data);
    }
  ...
  static void editPageInfo(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableEditPageLogging &&
  ...
  static void editPageWarning(String message,
      {String? tag, Map<String, dynamic>? data, Object? error}) {
    if (EditPageLoggingConfig.enableEditPageLogging &&
  ...
  static void fileOpsError(String message,
      {String? tag,
      Object? error,
      StackTrace? stackTrace,
      Map<String, dynamic>? data}) {
  ...
  static void fileOpsInfo(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableFileOpsLogging &&
        _shouldLog(LogLevel.info, EditPageLoggingConfig.fileOpsMinLevel)) {
      AppLogger.info(message,
          tag: tag ?? EditPageLoggingConfig.TAG_FILE_OPS, data: data);
    }
  }

  /// 文件操作性能日志
  static void logFileOperationPerformance(String operation, int elapsedMs,
      {String? tag, Map<String, dynamic>? additionalData}) {
    logPerformance(operation, elapsedMs,
        tag: tag ?? EditPageLoggingConfig.TAG_FILE_OPS,
        customThreshold:
            EditPageLoggingConfig.fileOperationPerformanceThreshold,
  ...
  static void logPerformance(String operation, int elapsedMs,
    ...
    if (elapsedMs > threshold) {
      performanceWarning('性能警告: $operation 耗时 ${elapsedMs}ms',
          tag: tag, data: data);
    } else if (_shouldLog(
        LogLevel.debug, EditPageLoggingConfig.performanceMinLevel)) {
      performanceInfo('性能监控: $operation 耗时 ${elapsedMs}ms',
          tag: tag, data: data);
    }
  }

  /// 渲染性能日志 - 专门用于渲染操作
  static void logRenderPerformance(String operation, int elapsedMs,
      {String? tag, Map<String, dynamic>? additionalData}) {
    logPerformance(operation, elapsedMs,
  ...
  static void performanceWarning(String message,
    ...
    if (EditPageLoggingConfig.enablePerformanceLogging &&
        _shouldLog(
            LogLevel.warning, EditPageLoggingConfig.performanceMinLevel)) {
      AppLogger.warning(message,
          tag: tag ?? EditPageLoggingConfig.TAG_PERFORMANCE, data: data);
    }
  }
  ...
  static void propertyPanelDebug(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enablePropertyPanelLogging &&
        _shouldLog(
            LogLevel.debug, EditPageLoggingConfig.propertyPanelMinLevel)) {
      AppLogger.debug(message,
          tag: tag ?? EditPageLoggingConfig.TAG_TEXT_PANEL, data: data);
    }
  }

  static void propertyPanelError(String message,
      {String? tag,
      Object? error,
      StackTrace? stackTrace,
      Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enablePropertyPanelLogging &&
        _shouldLog(
            LogLevel.error, EditPageLoggingConfig.propertyPanelMinLevel)) {
      AppLogger.error(message,
          tag: tag ?? EditPageLoggingConfig.TAG_TEXT_PANEL,
          error: error,
          stackTrace: stackTrace,
          data: data);
    }
  ...
  static void rendererDebug(String message,
      {String? tag, Map<String, dynamic>? data}) {
    if (EditPageLoggingConfig.enableRendererLogging &&
        _shouldLog(LogLevel.debug, EditPageLoggingConfig.rendererMinLevel)) {
      AppLogger.debug(message,
          tag: tag ?? EditPageLoggingConfig.TAG_RENDERER, data: data);
    }
  }

  static void rendererError(String message,
      {String? tag,
      Object? error,
      StackTrace? stackTrace,
      Map<String, dynamic>? data}) {
