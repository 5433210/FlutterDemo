...
class PracticeEditPageRefactored extends ConsumerStatefulWidget {
  final String? practiceId;

  const PracticeEditPageRefactored({super.key, this.practiceId});

  @override
  ConsumerState<PracticeEditPageRefactored> createState() =>
      _PracticeEditPageRefactoredState();
}
...
class _PracticeEditPageRefactoredState
    extends ConsumerState<PracticeEditPageRefactored> {
  // Controller
