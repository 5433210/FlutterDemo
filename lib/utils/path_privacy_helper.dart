...
class PathPrivacyHelper {
  ...
  /// 批量转换路径
  static Map<String, String> batchToRelativePaths(Map<String, String> absolutePaths) {
  ...
  static String sanitizePathForLogging(String filePath) {
    ...
    sanitized = sanitized.replaceAllMapped(
      ...
      (match) => '${match.group(0)!.substring(0, match.group(0)!.length - match.group(1)!.length - 1)}[USER]/',
    );
...
extension WorkImagePrivacyExtension on String {
  ...
  /// 清理用于日志记录
  String get sanitizedForLogging => PathPrivacyHelper.sanitizePathForLogging(this);
} 