...
class MultilingualMappingApplier:    def __init__(self, mapping_file_path, dry_run=False):
        ...
        for line in lines:
            ...
            if re.search(r'\{[^}]+\}', line) and ':' in line:
                ...
                if ': ' in line:
                    ...
                    if re.search(r'\{[^}]+\}', value_part) and not (value_part.startswith('"') and value_part.endswith('"')):
