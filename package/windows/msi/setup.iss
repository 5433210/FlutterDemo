...
; Output Settings
OutputDir=releases\windows\v1.0.1
OutputBaseFilename=CharAsGemInstaller_v1.0.1
...
Name: "associatefiles"; Description: "关联 .csg 文件"; GroupDescription: "文件关联"; Flags: unchecked
...
Name: "{group}\{cm:UninstallProgram,字字珠玑}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\字字珠玑"; Filename: "{app}\charasgem.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\字字珠玑"; Filename: "{app}\charasgem.exe"; Tasks: quicklaunchicon

[Registry]
; 文件关联
Root: HKCR; Subkey: ".csg"; ValueType: string; ValueName: ""; ValueData: "CharAsGemProject"; Flags: uninsdeletevalue; Tasks: associatefiles
Root: HKCR; Subkey: "CharAsGemProject"; ValueType: string; ValueName: ""; ValueData: "字字珠玑项目文件"; Flags: uninsdeletekey; Tasks: associatefiles
...
[Run]
; 安装完成后运行
Filename: "{app}\charasgem.exe"; Description: "{cm:LaunchProgram,字字珠玑}"; Flags: nowait postinstall skipifsilent

; 安装 Visual C++ Redistributable (如果需要)
; Filename: "{tmp}\VC_redist.x64.exe"; Parameters: "/quiet"; StatusMsg: "正在安装 Visual C++ Redistributable..."; Check: NeedsVCRedist
...
[Code]
// 检查是否需要 Visual C++ Redistributable
